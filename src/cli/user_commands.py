...
from src.cli.utils import console, display_error, display_success, set_active_user_id, get_active_user_id, UserNotFound, DuplicateUsername
    ...
    try:
        with get_db() as db:
            try:
                ...
                raise DuplicateUsername(f"Username '{username}' already exists.")
